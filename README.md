...
Fast implementation of the method described in the paper "LEMUR: Learned Multi-Vector Retrieval".
...
For combining LEMUR with approximate nearest neighbor search, we strongly recommend [pyglass](https://github.com/zilliztech/pyglass).
